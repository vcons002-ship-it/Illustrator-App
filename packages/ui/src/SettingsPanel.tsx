            ...
            {(isDesktop || remote) && value.imageProvider === "local" && isComfyBackend(value) ? (
              <div>
                ...
                <span style={{ display: "block", opacity: 0.55, fontSize: 11, marginTop: 4 }}>
                  ...
                  <strong>SD 1.5 and SDXL checkpoints only</strong> — IP-Adapter is the one reference route this app
                  builds locally, and it doesn&rsquo;t attach to Flux, Flux.2, Z-Image, Qwen-Image or HiDream. (Several
                  of those read reference images natively by another route; it isn&rsquo;t wired here yet.){" "}
